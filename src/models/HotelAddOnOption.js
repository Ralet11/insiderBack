...
export default (sequelize) => {
  const HotelAddOnOption = sequelize.define("HotelAddOnOption", {
    id:              { type: DataTypes.INTEGER, primaryKey: true, autoIncrement: true },
    hotel_add_on_id: { type: DataTypes.INTEGER, allowNull: false,
                       references: { model: "hotel_add_on", key: "id" }, onDelete: "CASCADE" },
    add_on_option_id:{ type: DataTypes.INTEGER, allowNull: false,
                       references: { model: "add_on_option", key: "id" }, onDelete: "CASCADE" },
